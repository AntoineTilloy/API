...
public class APIDemo {
	...
	public static void main(String[] args)  throws Exception {
		...
		try
		{
			...
			System.out.println("connexion � gregstubbe 01");
			...
			try	{
				...
				switch (choice) {
					...
					case 9://Auto Select
						...
						//Basics.Send("centaurecapital", "jonathan.donier@gmail.com antoine.tilloy@gmail.com pierre.baque@polytechnique.edu", "Trading Report", "Ok �a a l'air nickel");
						break;
					case 10: // Strat Auto	
						dailyPnL=0;
